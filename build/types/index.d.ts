import { AlignContent, AlignItems, AlignSelf, JustifyContent, JustifyItems, JustifySelf, PlaceContent, PlaceItems, PlaceSelf } from "./alignment";
import { BackgroundAttachment, BackgroundClip, BackgroundColor, BackgroundImage, BackgroundOpacity, BackgroundPosition, BackgroundRepeat, BackgroundSize, GradientColor } from "./background";
import { BorderColor, BorderOpacity, BorderRadius, BorderStyle, BorderWidth, DivideColor, DivideOpacity, DivideStyle, DivideWidth, RingColor, RingOffsetColor, RingOffsetWidth, RingOpacity, RingWidth } from "./border";
import { TailwindOpacities, TailwindShadows } from "./color";
import { FlexDirection, FlexWrap, Flex, FlexGrowShrink, Order } from "./flex";
import { GridTemplateCols, GridTemplateRows, GridCols, GridRows, GridFlow, GridAuto, Gap } from "./grid";
import { Cursor, Outline, PointerEvents, Resize, UserSelect } from "./interactivity";
import { BoxSizing, Display, Float, Clear, ObjectFit, ObjectPosition, Overflow, Overscroll, Position, ZIndex, TailwindSpaces } from "./layout";
import { Height, MaxHeight, MaxWidth, MinHeight, MinWidth, Width } from "./sizing";
import { Margin, Padding, SpaceBetween } from "./spacing";
import { StrokeWidth } from "./svg";
import { BorderCollapse, TableLayout } from "./table";
import { Rotate, Scale, Skew, Transform, TransformOrigin, Translate } from "./transform";
import { Animation, Delay, Duration, Ease, Transition } from "./transition";
import { FontFamily, FontSize, FontVariantNumeric, FontWeight, LetterSpacing, LineHeight, ListStyle, ListStylePosition, PlaceholderColor, PlaceholderOpacity, TextAlign, TextColor, TextOpacity, TextOverflow, VerticalAlign, Whitespace, Wordbreak } from "./typography";
declare type Responsive<T> = T | T[] | TailwindResponsive<T>;
